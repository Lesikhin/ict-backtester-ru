...
Стратегия **Sweep+MSS+FVG** протестирована на фьючерсе IMOEXF (Индекс МосБиржи) за период 1 год (4907 часовых свечей).

| Метрика       | Значение        | Интерпретация                     |
|---------------|-----------------|-----------------------------------|
| Всего сделок  | 299             | Статистически значимая выборка    |
| Win Rate      | 45.8%           | Норма для ICT-стратегий           |
| Profit Factor | 1.495           | Система прибыльна (> 1.0)         |
| Total Return  | +24.46%         | Годовая доходность                |
| Max Drawdown  | 4.56%           | Низкий уровень риска              |
| Average Win   | 5 391 руб.      | Средний выигрыш                   |
| Average Loss  | -3 049 руб.     | Средний проигрыш                  |
| Risk/Reward   | 1.77            | Прибыль в 1.77 раза больше убытка |
| Expectancy    | 818 руб./сделка | Положительное мат. ожидание       |

**Вывод:** Стратегия имеет положительное математическое ожидание и устойчивый профиль доходности. Несмотря на Win Rate ниже 50%, соотношение прибыли к убытку (RR = 1.77) обеспечивает стабильный рост капитала.
